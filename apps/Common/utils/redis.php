...
define("__REDIS_HOST__", getenv('REDIS_HOST'));
define("__REDIS_AUTH__", getenv('REDIS_AUTH'));
define("__REDIS_PORT__", getenv('REDIS_PORT'));
...
class ShermanRedis
{
    ...
    public static function getInstance()
    {
        if(!isset(self::$_instance)) {
            self::$_instance = new ShermanRedis();
        }
    ...
    */
    ...
    /*通用数据缓存时间*/
    private static function dataCacheExpire()
    {
        return 7200 + self::_getRandomTime();
    }
     ...
     */
    private static function _getRandomTime()
    {
